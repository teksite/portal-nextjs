  ...
  return (
    ...
    >
          ...
          <table className="w-full text-sm">
            ...
            <tr className="border-b border-zinc-100">
              ...
              <td className="p-3">
                  ...
                  >
                    {license.electronics == 0 ? 'غیرالکترونیکی' : (license.electronics == 1 ? 'الکترونیکی' : 'ترکیبی')}
                  </span>
              </td>
            </tr>
            <tr className="border-b border-zinc-100">
      ...
      <div className="flex border-t border-zinc-300 divide-x divide-zinc-300 dark:border-zinc-600 dark:divide-zinc-600">
        <button
          className="flex-1 p-3 text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors"
        >
          بستن
        </button>
        <Link
