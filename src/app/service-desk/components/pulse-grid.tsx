...
PlusGrid.Row = PlusGridRow;
PlusGrid.Item = PlusGridItem;

function PlusGridRow({ className = '', children }: { className?: string; children: React.ReactNode }) {
   return (
      <div
         className={clsx(
            className,
...
function PlusGridItem({ className = '', children }: { className?: string; children: React.ReactNode }) {
   return (
