import {SkeletonGroupedLicensesList} from "@/app/open-data/components/skeletons/skeleton-grouped-licenses-list";
import {SkeletonBreadcrumbs} from "@/components/skeletons/skeleton-breadcrumb";
import {SkeletonAside} from "@/app/open-data/components/skeletons/skeleton-aside";
    ...
    return (
        <>
            ...
            <div className='grid gap-6 lg:grid-cols-4 2xl:grid-cols-6'>
                <div>
                    <span className="w-24 h-24 p-2 shimmer block mb-6"></span>
                    <SkeletonAside />
                </div>
